...
<style>
	 ...
	 */
	/*
	 * ШАПКА ЛИПНЕ ДО ВЕРХУ ВІКНА — разом із виходом, який у ній і стоїть.
	 *
	 * У вікні QR, ідентифікатор, пароль і два способи підключення; на низькому
	 * екрані воно прокручується, і хрестик виїжджав геть разом із назвою. Закрити
	 * лишалося з клавіатури або кліком повз вікно — тобто способами, про які
	 * треба знати.
	 *
	 * Тло власне: під шапкою проїжджає вміст. Відʼємні відступи — щоб смуга
	 * доходила до країв вікна, а не лишала щілини кольору сторінки.
	 */
	.dialog__head {
		position: sticky;
		top: 0;
