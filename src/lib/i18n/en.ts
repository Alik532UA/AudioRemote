...
export const en: Record<TranslationKey, string> = {
	...
	'settings.nameTitle': 'Signature in the log',
	'settings.name': 'What to call you',
	'settings.nameAnon': 'Anonymous',
	'settings.nameHint':
		'Travels with every request and shows up in the action log. Empty means anonymous, as before. It is a signature, not an account: nothing checks it and it opens nothing.',
	...
	'panel.hush': 'Dim this row',
	'panel.byHost': 'here',
	'panel.logEmpty': 'Nothing has happened yet.',
	'panel.attention': 'Getting attention',
