...
export const uk = {
	...
	'remote.emptyLibraryWait': 'Зачекайте: папку обирають на компʼютері, що грає.',
	...
	'admin.modeHint': 'Ви міняєте дошку. Зміни їдуть на компʼютер, що грає.',
	'admin.waiting': 'Чекаємо налаштування з компʼютера…',
	...
	'admin.noFolder': 'Обрати папку можна лише на самому компʼютері, що грає.',
	...
	'player.libraryDenied':
		'База не прийняла список треків, тому пульт бачить дошку порожньою. Найімовірніше, у базі ще старі правила: викладіть свіжі з database.rules.json. Звук на цьому компʼютері працює як завжди.',
	'player.dbOffline':
