...
export const uk = {
	...
	'create.keepCalm':
		'Переписувати ці два рядки не обовʼязково: пара лишається на цьому пристрої, і подивитися її можна будь-коли — кнопкою підключення на самій дошці.',
	'create.keepCalmHint':
		'Знадобиться вона лише для переїзду: на іншому пристрої дошку відкривають цією ж парою.',
