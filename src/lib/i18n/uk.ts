...
export const uk = {
	...
	'player.pickAgain':
		'Теку треба обирати після кожного перезавантаження сторінки: браузер аварійно закривається, якщо застосунок намагається її запамʼятати.',
	'player.scanning': 'Читаємо теку…',
	'player.found': 'Знайдено треків: {count}',
	'player.empty': 'У цій теці немає аудіофайлів.',
	'player.noFolder': 'Оберіть теку з музикою — треки зʼявляться тут.',
	...
	'hotkeys.hint':
		'Пробіл — пауза, 0 — стоп, стрілки — гучність і перемотка, M — тиша. Трекам можна призначити будь-яку клавішу.',
