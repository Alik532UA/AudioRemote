...
export const uk = {
	...
	'create.hint': 'Продиктуйте ці два рядки тому, хто керуватиме.',
	'create.fromSettings':
	...
	'error.emulatorDown':
		'Локальний емулятор Firebase не запущено. Відкрийте другий термінал у папці проєкту й виконайте: npm run emulators',
