...
export const uk = {
	...
	'app.tagline': "Комп'ютер грає — телефон керує",
	...
	'entry.lead':
		'Створіть дошку на комп’ютері, який гратиме звук. З телефона — підключіться до неї.',
	'entry.create': 'Створити дошку',
	'entry.createHint': 'На комп’ютері, який гратиме',
	'entry.connect': 'Підключитися',
	'entry.connectHint': 'З телефона або іншого пристрою',
