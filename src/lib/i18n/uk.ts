...
export const uk = {
	...
	'deck.logHide': 'Згорнути журнал',
	'deck.logShow': 'Розгорнути журнал',
	'deck.logFolded': 'Записів: {count}',
	...
	'panel.helpTitle': 'Як це працює',
	'panel.helpHide': 'Згорнути підказку',
	'panel.helpShow': 'Розгорнути підказку',
	'panel.editHint':
	...
	'panel.hideButton': 'Приховати кнопку {n}',
	'panel.showButton': 'Показати кнопку {n}',
	'panel.deleteButton': 'Видалити кнопку {n}',
	'panel.shrinkFit': 'Зменшити розмір віджета',
	'panel.expandBoard': 'Збільшити розмір дошки',
	'panel.backToEdit': 'Повернутися до редагування',
	'panel.important': 'Важлива дія',
	'panel.importantHint':
		'Натискання на мить заливає екран кольором кнопки або віджета (або протилежною темою, якщо без кольору). Це видно краєм ока, навіть коли дивитися на пульт.',
	...
	'panel.attentionColor': 'Колір для стандартних кнопок',
	'panel.viewTitle': 'Відображати на цій сторінці',
	'panelView.both': 'І те, і те',
	'panelView.main': 'Панель',
