 ...
 *
 * Гучність мусить обиратися, а не задаватися: у малому залі з двома акторами
 * досить підсвіченої кнопки, у великому з оркестром — ні. Тому три режими, і
 * найтихіший із них лишається типовим: застосунок, який блимає на весь екран
 * без попиту, вимикають на другій виставі.
 *
 * | Режим | Що робиться на прохання із зали |
 * |---|---|
 * | `min` | нічого понад звичайну підсвітку кнопки |
 * | `head` | смуга застосунку на секунду міняє колір |
 * | `page` | тло всієї сторінки на секунду міняє колір |
 *
