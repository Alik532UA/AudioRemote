...
<div class="stack stack--auth">
	<section class="card card--auth stack">
		...
		<!--
			ВІДПОВІДЬ НА ПИТАННЯ, ЯКЕ ЛЮДИНА СТАВИТЬ МОВЧКИ.
			
			Побачивши два згенеровані рядки, вона тягнеться по ручку: а раптом це
			єдиний раз, коли їх видно. Не сказати нічого означає або зайвий папірець
			із паролем у залі, або страх його втратити — обидва наслідки гірші за
			два рядки тексту.
			
			Другий рядок обовʼязковий і не прикрашає: «лишається» означає «на ЦЬОМУ
			пристрої». Обіцянка без цього уточнення була б неправдою рівно тоді,
			коли її найдорожче виявити, — при переїзді на інший компʼютер.
		-->
		<p class="muted" data-testid="keep-calm-text">{t('create.keepCalm')}</p>
		<p class="muted">{t('create.keepCalmHint')}</p>
