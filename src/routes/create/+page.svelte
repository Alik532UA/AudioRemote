...
<div class="stack stack--auth">
	<section class="card card--auth stack">
		...
		<!--
			ОДИН РЯДОК НА ВСЕ ПИТАННЯ, а не чотири абзаци довкола нього.
			
			Тут їх і було чотири: «не треба переписувати», «знадобиться для
			переїзду», «пароль не змінити» і «продиктуйте». Разом вони давали
			стіну тексту рівно там, де людина хоче одного — натиснути «Створити».
			Стіну не читають, тож не працював жоден із чотирьох, включно з
			найпотрібнішим.
			
			Лишилося те, заради чого все й писалося: переписувати не обовʼязково,
			бо пара нікуди не дінеться.
		-->
